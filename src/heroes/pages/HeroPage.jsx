...
export const HeroPage = () => {
  ...
  const hero = useMemo(() => getHeroById(id), [id]); // estamos usando useMemo para memorizar el resultado de getHeroById(id) y evitar cálculos innecesarios en cada renderizado. Esto es útil si la función getHeroById es costosa o si el componente se vuelve a renderizar con frecuencia.
  const onNavifateBack = () => {
  ...
  const { superhero, publisher, alter_ego, first_appearance, characters } =
    hero; // Destructure the hero object to get the properties
